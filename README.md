...
# Quizex - an autonomous Quiz Solver Agent
...
- ✅ **Self-installing dependencies**: Automatically adds required Python packages using pip
...
7. **Pip for Dependencies**: Standard package management using requirements.txt
